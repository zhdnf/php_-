<?php
/* Smarty version 3.1.32, created on 2018-09-07 14:36:51
  from 'C:\phpstudy\PHPTutorial\WWW\progame\web\template\tpl\user\add.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5b921c83eac4d4_72582524',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2e5b61aabe8099b86b782e2cfed1b92d6d1ce9f3' => 
    array (
      0 => 'C:\\phpstudy\\PHPTutorial\\WWW\\progame\\web\\template\\tpl\\user\\add.tpl',
      1 => 1536223071,
      2 => 'file',
    ),
  ),
...
function content_5b921c83eac4d4_72582524 (Smarty_Internal_Template $_smarty_tpl) {
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br submit-form" action="<?php echo url('user/manage/add');?>
" method="post">
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label">管理员名称</label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" name="username" placeholder="请输入管理名称">
                                        </div>
                                    </div>
									<div class="am-form-group">
